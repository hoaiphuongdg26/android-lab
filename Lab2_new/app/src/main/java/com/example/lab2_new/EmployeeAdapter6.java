...
public  class EmployeeAdapter6 extends  RecyclerView.Adapter<EmployeeAdapter6.EmployeeHolder>{
    private Activity context=null;
    private int layoutID;
    private List<Employee6> mListEmployee=null;

    public EmployeeAdapter6(Activity context, int layoutID, List<Employee6> mListEmployee) {
        this.context = context;
        this.layoutID = layoutID;
        this.mListEmployee = mListEmployee;
    }

    public List<Employee6> getmListEmployee() {
        return mListEmployee;
    }

    public void setmListEmployee(List<Employee6> mListEmployee) {
        this.mListEmployee = mListEmployee;
    }
    ...
    public EmployeeHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_employee6, null,
                false);
    ...
    public void onBindViewHolder(@NonNull EmployeeHolder holder, int position) {
        Employee6 employee = mListEmployee.get(position);
        if (employee == null ) {
            return;
        }
